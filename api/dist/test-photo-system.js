...
exports.testPhotoSystem = testPhotoSystem;
exports.testPhotoValidationLogic = testPhotoValidationLogic;
const global_hotel_fetcher_1 = require("./global-hotel-fetcher");
...
async function testPhotoSystem() {
    ...
    console.log('');
    const fetcher = new global_hotel_fetcher_1.GlobalHotelFetcher();
    ...
    try {
        ...
        for (const url of samplePhotoUrls) {
            const optimizedUrl = photo_validator_1.PhotoValidator.optimizePhotoUrl(url, 1920, 1080);
...
async function testPhotoValidationLogic() {
    ...
    testUrls.forEach((url, index) => {
        const optimized = photo_validator_1.PhotoValidator.optimizePhotoUrl(url, 1920, 1080);
...
//# sourceMappingURL=test-photo-system.js.map