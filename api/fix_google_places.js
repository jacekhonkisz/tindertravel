...
// Add the missing getSpecificHotelPhotos method before the closing brace
const methodToAdd = `  /**
...
content = content.replace('}', methodToAdd + '}');

// Write the file back
fs.writeFileSync('src/google-places.ts', content);
console.log('✅ Added getSpecificHotelPhotos method to GooglePlacesClient');
