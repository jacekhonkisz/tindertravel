...
interface GlintzHotelSeed {
  ...
  bookingUrl: string;
  rating: number;
  searchQuery: string; // For Google Places photo search
}

const GLINTZ_HOTEL_SEEDS: GlintzHotelSeed[] = [
  {
    name: "Aman Tokyo",
    city: "Tokyo",
    country: "Japan",
...
export const PHOTO_QUALITY_REQUIREMENTS = {
  minPhotos: 4,
  maxPhotos: 8,
  minWidth: 1200,
  minHeight: 800,
