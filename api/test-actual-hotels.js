...
class ActualHotelsTester {
  constructor() {
    this.serpApiKey = '2e23f222aecca24206a3d1dc3df64ba79b642aeec1c0a67baa0ae046d6a81b5f';
    this.baseUrl = 'https://serpapi.com/search';
  }

  async testActualHotels() {
    console.log('🏨 Testing SerpApi with ACTUAL hotels from your database...');
    ...
    try {
      ...
      console.log(`📊 Testing ${hotels.length} actual hotels`);
...
async function runTest() {
  const tester = new ActualHotelsTester();
  await tester.testActualHotels();
}
