...
class SabreTokenFixedTester {
  constructor() {
    ...
    console.log('🔧 Sabre Token Fixed Tester');
    console.log(`📍 Base URL: ${this.baseUrl}`);
    console.log(`🎫 Access Token: ${this.accessToken.substring(0, 30)}...`);
  }

  async testTokenValidity() {
    console.log('\n🔑 Testing token validity with proper parameters...');
    
    try {
      // Test with flights API with required parameters
  ...
  async testHotelDescriptiveInfo() {
    console.log('\n🏨 Testing GetHotelDescriptiveInfoRQ API...');
    ...
    const endpoints = [
      ...
      '/v1/hotels/GetHotelDescriptiveInfo',
      '/v1/shop/GetHotelDescriptiveInfo',
  ...
  async testHotelSearch() {
    console.log('\n🔍 Testing hotel search endpoints...');
  ...
  async runAllTests() {
    console.log('🚀 Testing Sabre Access Token for Hotel APIs\n');
    ...
    if (!hotelMediaResult) {
      ...
      const hotelDescriptiveResult = await this.testHotelDescriptiveInfo();
      
      if (!hotelDescriptiveResult) {
    ...
    if (hotelMediaResult) {
      ...
      console.log('\n⚠️ This token doesn\'t have hotel photo access');
...
// Run the tests
const tester = new SabreTokenFixedTester();
